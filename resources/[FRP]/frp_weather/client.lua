...
RegisterNetEvent("FRP:W:setweather")
AddEventHandler("FRP:W:setweather",function(weather)
    Citizen.InvokeNative(0x59174F1AFE095B5A, GetHashKey(weather), true, false, true, 15.0, false)
end)
