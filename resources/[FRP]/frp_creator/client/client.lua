...
function defaultbody()
    if sex == "mp_male" then  
        HeadUsing = MaleHeads[4].hash
        TorsoUsing = MaleTorsos[5].hash
        LegsUsing = MaleLegs[5].hash
        EyesUsing = MaleEyes[2].hash
        TeethUsing = MaleTeeth[1].hash
        HairUsing = MaleHairs[45].hash
        MustacheUsing = MaleMustache[64].hash
        pedWeight = 11
        PorteUsing = 135

    else
        HeadUsing = FemaleHeads[7].hash
        TorsoUsing = FemaleTorsos[2].hash
        LegsUsing = FemaleLegs[1].hash
        EyesUsing = FemaleEyes[2].hash
        TeethUsing = FemaleTeeth[1].hash
        HairUsing = FemaleHairs[4].hash
        pedWeight = 11
        PorteUsing = 17
    end
end
    ...
    for k, v in pairs(peds) do
        if choosePed[k] == nil then
            ...
            if peds[k].genrer == "mp_female" then
                defaultbodycreatePeds(choosePed[k], peds[k].genrer)
...
function defaultbodycreatePeds(pedSelected, genrer)
    if genrer == "mp_male" then  
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleHeads[4].hash, true, true, true) -- FACE
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleTorsos[5].hash, true, true, true) -- TORSO TOM DE PELE
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleLegs[5].hash, true, true, true) -- PERNAS TOM DE PELE
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleEyes[2].hash, true, true, true) --OLHOS
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleTeeth[1].hash, true, true, true) --DENTES
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleHairs[45].hash, true, true, true) --CABELO
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, MaleMustache[64].hash, true, true, true)

        Citizen.InvokeNative(0x1902C4CFCC5BE57C,pedSelected, 1745919061)  -- WAIST_TYPES[pedWeight]
        Citizen.InvokeNative(0xCC8CA3E88256E58F,pedSelected, 0, 1, 1, 1, false)

        Citizen.InvokeNative(0xA5BAE410B03E7371, pedSelected, 135, false, true)        
        Citizen.InvokeNative(0xCC8CA3E88256E58F, pedSelected, 0, 1, 1, 1, 0)

    elseif  genrer == "mp_female" then
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, FemaleHeads[7].hash, true, true, true) -- FACE
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, FemaleTorsos[2].hash, true, true, true) -- TORSO TOM DE PELE
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, FemaleLegs[1].hash, true, true, true) -- PERNAS TOM DE PELE
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, FemaleEyes[2].hash, true, true, true) --OLHOS
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, FemaleTeeth[1].hash, true, true, true) --DENTES
        Citizen.InvokeNative(0xD3A7B003ED343FD9, pedSelected, FemaleHairs[4].hash, true, true, true) --CABELO

        Citizen.InvokeNative(0x1902C4CFCC5BE57C,pedSelected, 1745919061)  -- WAIST_TYPES[pedWeight]
        Citizen.InvokeNative(0xCC8CA3E88256E58F,pedSelected, 0, 1, 1, 1, false)

        Citizen.InvokeNative(0xA5BAE410B03E7371, pedSelected, 17, false, true)        
        Citizen.InvokeNative(0xCC8CA3E88256E58F, pedSelected, 0, 1, 1, 1, 0)
    end
