...
AddEventHandler("FRP:RESPAWN:SetPlayerAsDead",function(bool)
        local _source = source
        local User = API.getUserFromSource(_source)
        local Character = User:getCharacter()
...
AddEventHandler("FRP:RESPAWN:SetPlayerDamage",function(data)
...
AddEventHandler("FRP:RESPAWN:SetPlayerAsAliveAndClearInventory",function()
        local _source = source
        local User = API.getUserFromSource(_source)
        local Character = User:getCharacter()
...
AddEventHandler("FRP:RESPAWN:CheckDeath",function()
        local _source = source
        local User = API.getUserFromSource(_source)
        local Character = User:getCharacter()
